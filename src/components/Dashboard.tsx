...
const Dashboard = ({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 z-[70] md:flex flex-col w-72 md:w-20 lg:w-64 xl:w-72 h-[100dvh] border-r-2 border-brutal-ink bg-brutal-parchment shadow-brutal-sidebar transition-transform duration-300 ${
